...
// Chirp's avatar: an inline whistle-face badge that always renders. If
// /chirp.png exists it overlays on top (the uploaded logo wins); otherwise the
// drawn face shows.
export default function ChirpAvatar({ size = 28, className = '' }: { size?: number; className?: string }) {
  return (
    <span
