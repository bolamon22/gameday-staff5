...
export const TEMPLATE_CATALOG: TemplateCatalogEntry[] = [
  ...
  { key: '2gg-4',         label: 'Both-ways consolation',   teamCount: 4,  gameCount: 4,  description: '4 games · championship + 3rd place',          format: '2gg'    },
  { key: '2gg-8',         label: 'Both-ways consolation',   teamCount: 8,  gameCount: 11, description: '11 games · winners + consolation brackets · Champion & Consolation Champion (every team plays 2 bracket games)', format: '2gg'    },
  { key: '2gg-16',        label: 'Both-ways consolation',   teamCount: 16, gameCount: 23, description: '23 games · winners + consolation brackets · Champion & Consolation Champion (every team plays 2 bracket games)', format: '2gg'    },
]
